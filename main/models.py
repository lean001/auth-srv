...
# add by lean
    mac_t = db.Column(db.Unicode(64), default=None)
    wechat = db.Column(db.Unicode(128), default=None)
# add by lean
    ...
    def __init__(self, username, plaintext_password, email, wechat=None, mac=None, admin=False, enabled=True, quota=DEFAULT_QUOTA):
...
class Media(db.Model):
    ...
    media_id = db.Column(db.Unicode(128))
